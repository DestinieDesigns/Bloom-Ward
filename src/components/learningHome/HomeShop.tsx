            ...
            {filteredItems.length === 0 ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {pagedItems.map((item) => {
                    const isOwned = unlockedSet.has(item.id) || item.unlocked;
                    const price = item.price ?? 0;
                      ...
                      >
                        ...
                        <div>
                          <div className="flex items-start justify-between">
                            ...
                            {isOwned && (
                              <span className="text-[11px] font-extrabold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 flex items-center gap-1">
                        ...
                        <div className="mt-4 pt-3 border-t border-stone-100 flex items-center justify-between gap-2">
                          ...
                          {isOwned ? (
                            <button
                              ...
                              className="px-4 py-2 rounded-xl bg-stone-100 hover:bg-amber-500 hover:text-white text-stone-700 font-extrabold text-xs flex items-center gap-1 transition-colors cursor-pointer"
                            >
